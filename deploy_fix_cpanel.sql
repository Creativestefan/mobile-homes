-- --------------------------------------------------------
-- CLEAN SLATE SETUP FOR CPANEL (MySQL)
-- --------------------------------------------------------
...
-- 2. Create the inventory table with NEW schema
...
-- 6. Insert the demo inventory data
...
-- 7. Insert default admin user: username 'admin', password 'password123'
