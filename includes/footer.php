    ...
    <div class="container">
        <div class="footer-grid">
            <div class="footer-col brand-col">
                ...
                <p><?php echo htmlspecialchars($settings['about_text']); ?></p>
            ...
            <div class="footer-col">
                ...
                <ul>
                    ...
                    <li>📍 <?php echo htmlspecialchars($settings['contact_address']); ?></li>
                    <li>🕒 <?php echo htmlspecialchars($settings['contact_hours']); ?></li>
                </ul>
            </div>
        </div>
...
<div class="whatsapp-widget">
    <a href="https://wa.me/<?php echo preg_replace('/[^0-9]/', '', $settings['contact_phone']); ?>"
        class="whatsapp-button" target="_blank" rel="noopener noreferrer" aria-label="Contact us on WhatsApp">
